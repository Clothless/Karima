          ...
          child: GestureDetector(
            ...
            child: ListView(
              children: [
                ...
                buildTextField("Full Name", controller.userModel!.fullName!, false, full),
                const SizedBox(
                  height: 35,
                ),
                Row(
                  ...
                  children: [
                    ...
                    CustomButton(
                      onPress: () {
                        if(full.text != ""){
                          controller.userModel!.fullName = full.text;
                        }
                        
                        FireStoreUser().addUserToFirestore(controller.userModel!);
                        Get.back();
                        Get.snackbar(
                          'Information Saved!',
